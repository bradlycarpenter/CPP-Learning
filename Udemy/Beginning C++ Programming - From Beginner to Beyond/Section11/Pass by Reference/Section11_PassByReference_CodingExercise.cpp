...
string print_guest_list(
    const string &guest_1,
    const string &guest_2,
    const string &guest_3);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
void clear_guest_list(
    string &guest1,
    string &guest2,
    string &guest3);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
